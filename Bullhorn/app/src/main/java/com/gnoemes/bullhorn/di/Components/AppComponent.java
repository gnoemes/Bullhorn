...
import com.gnoemes.bullhorn.di.Modules.ApplicationModule.RepositoryModule;
...
@Singleton
@Component(modules = {AppModule.class, NetModule.class, PreferenceModule.class, RepositoryModule.class})
